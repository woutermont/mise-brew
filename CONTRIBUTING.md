...
This is pimarily a project for personal use. Issues and Pull Requests are welcome, but without guarantees.

Below is a copy of the README of the [Mise backend plugin template](https://github.com/jdx/mise-backend-plugin-template) repository.
